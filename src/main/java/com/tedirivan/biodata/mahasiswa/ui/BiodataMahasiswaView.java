...
public class BiodataMahasiswaView extends javax.swing.JFrame {
    ...
    private void load() {
        try {
            ...
            PreparedStatement preparedStatement = DBConnection.getKoneksi().prepareStatement(sqlSelect);
    ...
    private void insert() {
        try {
            ...
            PreparedStatement preparedStatement = DBConnection.getKoneksi().prepareStatement(sqlInsert);
    ...
    private void update(){
        try {
            ...
            if (row != -1) {
                ...
                PreparedStatement preparedStatement = DBConnection.getKoneksi().prepareStatement(sqlUpdate);
    ...
    private void delete() {
        try {
            ...
            if (row != -1) {
                ...
                PreparedStatement preparedStatement = DBConnection.getKoneksi().prepareStatement(sqlDelete);
